...
function(a){"undefined"===typeof a&&(a=null);a||(a=this);var b=this.length();if(1===b)return this;if(0===b)return a.x=0,a.y=0,a.z=0,a;b=1/b;a.x*=b;a.y*=b;a.z*=b;return a};d.prototype.multiplyByMat3=function(a,b){"undefined"===typeof b&&(b=null);b||(b=this);return a.multiplyVec3(this,b)};d.prototype.multiplyByQuat=function(a,b){"undefined"===typeof b&&(b=null);b||(b=this);return a.multiplyVec3(this,b)};d.cross=function(a,b,c){"undefined"===typeof c&&(c=null);c||(c=new d);var g=a.x,e=a.y,a=a.z,f=b.x,
h=b.y,b=b.z;c.x=e*b-a*h;c.y=a*f-g*b;c.z=g*h-e*f;return c};d.dot=function(a,b){return a.x*b.x+a.y*b.y+a.z*b.z};d.distance=function(a,b){return Math.sqrt(this.squaredDistance(a,b))};d.squaredDistance=function(a,b){var c=b.x-a.x,d=b.y-a.y,e=b.z-a.z;return c*c+d*d+e*e};d.direction=function(a,b,c){"undefined"===typeof c&&(c=null);c||(c=new d);var g=a.x-b.x,e=a.y-b.y,a=a.z-b.z,b=Math.sqrt(g*g+e*e+a*a);if(0===b)return c.x=0,c.y=0,c.z=0,c;b=1/b;c.x=g*b;c.y=e*b;c.z=a*b;return c};d.mix=function(a,b,c,g){"undefined"===
typeof g&&(g=null);g||(g=new d);g.x=a.x+c*(b.x-a.x);g.y=a.y+c*(b.y-a.y);g.z=a.z+c*(b.z-a.z);return g};d.sum=function(a,b,c){"undefined"===typeof c&&(c=null);c||(c=new d);c.x=a.x+b.x;c.y=a.y+b.y;c.z=a.z+b.z;return c};d.difference=function(a,b,c){"undefined"===typeof c&&(c=null);c||(c=new d);c.x=a.x-b.x;c.y=a.y-b.y;c.z=a.z-b.z;return c};d.product=function(a,b,c){"undefined"===typeof c&&(c=null);c||(c=new d);c.x=a.x*b.x;c.y=a.y*b.y;c.z=a.z*b.z;return c};d.quotient=function(a,b,c){"undefined"===typeof c&&
...
return a.multiplyVec4(this,b)};d.mix=function(a,b,c,g){"undefined"===typeof g&&(g=null);g||(g=new d);g.x=a.x+c*(b.x-a.x);g.y=a.y+c*(b.y-a.y);g.z=a.z+c*(b.z-a.z);g.w=a.w+c*(b.w-a.w);return g};d.sum=function(a,b,c){"undefined"===typeof c&&(c=null);c||(c=new d);c.x=a.x+b.x;c.y=a.y+b.y;c.z=a.z+b.z;c.w=a.w+b.w;return c};d.difference=function(a,b,c){"undefined"===typeof c&&(c=null);c||(c=new d);c.x=a.x-b.x;c.y=a.y-b.y;c.z=a.z-b.z;c.w=a.w-b.w;return c};d.product=function(a,b,c){"undefined"===typeof c&&(c=
...
function(a){var b=this.values[0],c=this.values[1],d=this.values[2],e=this.values[3],f=this.values[4],h=this.values[5],j=this.values[6],i=this.values[7],p=this.values[8],k=a.at(0),m=a.at(1),n=a.at(2),E=a.at(3),s=a.at(4),t=a.at(5),w=a.at(6),q=a.at(7),a=a.at(8);this.values[0]=k*b+m*e+n*j;this.values[1]=k*c+m*f+n*i;this.values[2]=k*d+m*h+n*p;this.values[3]=E*b+s*e+t*j;this.values[4]=E*c+s*f+t*i;this.values[5]=E*d+s*h+t*p;this.values[6]=w*b+q*e+a*j;this.values[7]=w*c+q*f+a*i;this.values[8]=w*d+q*h+a*p;
...
this.values[1],this.values[2],0,this.values[3],this.values[4],this.values[5],0,this.values[6],this.values[7],this.values[8],0,0,0,0,1])};d.prototype.toQuat=function(){var a=this.values[0],b=this.values[1],c=this.values[2],d=this.values[3],e=this.values[4],f=this.values[5],h=this.values[6],j=this.values[7],i=this.values[8],p=a-e-i,k=e-a-i,m=i-a-e,n=0,a=a+e+i;p>a&&(a=p,n=1);k>a&&(a=k,n=2);m>a&&(a=m,n=3);p=0.5*Math.sqrt(a+1);k=0.25/p;m=new l.quat;switch(n){case 0:m.w=p;m.x=(f-j)*k;m.y=(h-c)*k;m.z=(b-
d)*k;break;case 1:m.w=(f-j)*k;m.x=p;m.y=(b+d)*k;m.z=(h+c)*k;break;case 2:m.w=(h-c)*k;m.x=(b+d)*k;m.y=p;m.z=(f+j)*k;break;case 3:m.w=(b-d)*k,m.x=(h+c)*k,m.y=(f+j)*k,m.z=p}return m};d.prototype.rotate=function(a,b){var c=b.x,d=b.y,e=b.z,f=Math.sqrt(c*c+d*d+e*e);if(!f)return null;1!==f&&(f=1/f,c*=f,d*=f,e*=f);var h=Math.sin(a),j=Math.cos(a),i=1-j,f=this.values[0],p=this.values[1],k=this.values[2],m=this.values[4],n=this.values[5],E=this.values[6],s=this.values[8],t=this.values[9],w=this.values[10],q=
c*c*i+j,r=d*c*i+e*h,v=e*c*i-d*h,u=c*d*i-e*h,l=d*d*i+j,y=e*d*i+c*h,z=c*e*i+d*h,c=d*e*i-c*h,e=e*e*i+j;this.values[0]=f*q+m*r+s*v;this.values[1]=p*q+n*r+t*v;this.values[2]=k*q+E*r+w*v;this.values[3]=f*u+m*l+s*y;this.values[4]=p*u+n*l+t*y;this.values[5]=k*u+E*l+w*y;this.values[6]=f*z+m*c+s*e;this.values[7]=p*z+n*c+t*e;this.values[8]=k*z+E*c+w*e;return this};d.product=function(a,b,c){"undefined"===typeof c&&(c=null);var g=a.at(0),e=a.at(1),f=a.at(2),h=a.at(3),j=a.at(4),i=a.at(5),p=a.at(6),k=a.at(7),a=
...
1!==f&&(f=1/f,c*=f,d*=f,e*=f);var h=Math.sin(a),j=Math.cos(a),i=1-j,f=this.values[0],p=this.values[1],k=this.values[2],m=this.values[3],n=this.values[4],l=this.values[5],s=this.values[6],t=this.values[7],w=this.values[8],q=this.values[9],r=this.values[10],v=this.values[11],u=c*c*i+j,A=d*c*i+e*h,y=e*c*i-d*h,z=c*d*i-e*h,B=d*d*i+j,C=e*d*i+c*h,D=c*e*i+d*h,c=d*e*i-c*h,e=e*e*i+j;this.values[0]=f*u+n*A+w*y;this.values[1]=p*u+l*A+q*y;this.values[2]=k*u+s*A+r*y;this.values[3]=m*u+t*A+v*y;this.values[4]=f*
z+n*B+w*C;this.values[5]=p*z+l*B+q*C;this.values[6]=k*z+s*B+r*C;this.values[7]=m*z+t*B+v*C;this.values[8]=f*D+n*c+w*e;this.values[9]=p*D+l*c+q*e;this.values[10]=k*D+s*c+r*e;this.values[11]=m*D+t*c+v*e;return this};d.frustum=function(a,b,c,g,e,f){var h=b-a,j=g-c,i=f-e;return new d([2*e/h,0,0,0,0,2*e/j,0,0,(b+a)/h,(g+c)/j,-(f+e)/i,-1,0,0,-(2*f*e)/i,0])};d.perspective=function(a,b,c,g){a=c*Math.tan(a*Math.PI/360);b*=a;return d.frustum(-b,b,-a,a,c,g)};d.orthographic=function(a,b,c,g,e,f){var h=b-a,j=
g-c,i=f-e;return new d([2/h,0,0,0,0,2/j,0,0,0,0,-2/i,0,-(a+b)/h,-(g+c)/j,-(f+e)/i,1])};d.lookAt=function(a,b,c){"undefined"===typeof c&&(c=l.vec3.up);if(a.equals(b))return this.identity;var b=l.vec3.difference(a,b).normalize(),c=l.vec3.cross(c,b).normalize(),g=l.vec3.cross(b,c).normalize();return new d([c.x,g.x,b.x,0,c.y,g.y,b.y,0,c.z,g.z,b.z,0,-l.vec3.dot(c,a),-l.vec3.dot(g,a),-l.vec3.dot(b,a),1])};d.product=function(a,b,c){"undefined"===typeof c&&(c=null);var g=a.at(0),e=a.at(1),f=a.at(2),h=a.at(3),
j=a.at(4),i=a.at(5),p=a.at(6),k=a.at(7),m=a.at(8),n=a.at(9),l=a.at(10),s=a.at(11),t=a.at(12),w=a.at(13),q=a.at(14),a=a.at(15),r=b.at(0),v=b.at(1),u=b.at(2),A=b.at(3),y=b.at(4),z=b.at(5),B=b.at(6),C=b.at(7),D=b.at(8),F=b.at(9),x=b.at(10),G=b.at(11),H=b.at(12),I=b.at(13),J=b.at(14),b=b.at(15);return c?(c.init([r*g+v*j+u*m+A*t,r*e+v*i+u*n+A*w,r*f+v*p+u*l+A*q,r*h+v*k+u*s+A*a,y*g+z*j+B*m+C*t,y*e+z*i+B*n+C*w,y*f+z*p+B*l+C*q,y*h+z*k+B*s+C*a,D*g+F*j+x*m+G*t,D*e+F*i+x*n+G*w,D*f+F*p+x*l+G*q,D*h+F*k+x*s+G*a,
H*g+I*j+J*m+b*t,H*e+I*i+J*n+b*w,H*f+I*p+J*l+b*q,H*h+I*k+J*s+b*a]),c):new d([r*g+v*j+u*m+A*t,r*e+v*i+u*n+A*w,r*f+v*p+u*l+A*q,r*h+v*k+u*s+A*a,y*g+z*j+B*m+C*t,y*e+z*i+B*n+C*w,y*f+z*p+B*l+C*q,y*h+z*k+B*s+C*a,D*g+F*j+x*m+G*t,D*e+F*i+x*n+G*w,D*f+F*p+x*l+G*q,D*h+F*k+x*s+G*a,H*g+I*j+J*m+b*t,H*e+I*i+J*n+b*w,H*f+I*p+J*l+b*q,H*h+I*k+J*s+b*a])};d.identity=(new d).setIdentity();l.mat4=d})(TSM||(TSM={}));
(function(l){var d=function(a){"undefined"===typeof a&&(a=null);this.values=new Float32Array(4);a&&(this.xyzw=a)};Object.defineProperty(d.prototype,"x",{get:function(){return this.values[0]},set:function(a){this.values[0]=a},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"y",{get:function(){return this.values[1]},set:function(a){this.values[1]=a},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"z",{get:function(){return this.values[2]},set:function(a){this.values[2]=
a},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"w",{get:function(){return this.values[3]},set:function(a){this.values[3]=a},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"xy",{get:function(){return[this.values[0],this.values[1]]},set:function(a){this.values[0]=a[0];this.values[1]=a[1]},enumerable:!0,configurable:!0});Object.defineProperty(d.prototype,"xyz",{get:function(){return[this.values[0],this.values[1],this.values[2]]},set:function(a){this.values[0]=
...
this.values[0],c=this.values[1],d=this.values[2],e=this.values[3],f=a.x,h=a.y,j=a.z,a=a.w;this.x=b*a+e*f+c*j-d*h;this.y=c*a+e*h+d*f-b*j;this.z=d*a+e*j+b*h-c*f;this.w=e*a-b*f-c*h-d*j;return this};d.prototype.multiplyVec3=function(a,b){"undefined"===typeof b&&(b=null);b||(b=new l.vec3);var c=a.x,d=a.y,e=a.z,f=this.x,h=this.y,j=this.z,i=this.w,p=i*c+h*e-j*d,k=i*d+j*c-f*e,m=i*e+f*d-h*c,c=-f*c-h*d-j*e;b.x=p*i+c*-f+k*-j-m*-h;b.y=k*i+c*-h+m*-f-p*-j;b.z=m*i+c*-j+p*-h-k*-f;return b};d.prototype.toMat3=function(a){"undefined"===
typeof a&&(a=null);a||(a=new l.mat3);var b=this.x,c=this.y,d=this.z,e=this.w,f=b+b,h=c+c,j=d+d,i=b*f,p=b*h,b=b*j,k=c*h,c=c*j,d=d*j,f=e*f,h=e*h,e=e*j;a.init([1-(k+d),p+e,b-h,p-e,1-(i+d),c+f,b+h,c-f,1-(i+k)]);return a};d.prototype.toMat4=function(a){"undefined"===typeof a&&(a=null);a||(a=new l.mat4);var b=this.x,c=this.y,d=this.z,e=this.w,f=b+b,h=c+c,j=d+d,i=b*f,p=b*h,b=b*j,k=c*h,c=c*j,d=d*j,f=e*f,h=e*h,e=e*j;a.init([1-(k+d),p+e,b-h,0,p-e,1-(i+d),c+f,0,b+h,c-f,1-(i+k),0,0,0,0,1]);return a};d.sum=function(a,
b,c){"undefined"===typeof c&&(c=null);c||(c=new d);c.x=a.x+b.x;c.y=a.y+b.y;c.z=a.z+b.z;c.w=a.w+b.w;return c};d.product=function(a,b,c){"undefined"===typeof c&&(c=null);c||(c=new d);var g=a.x,e=a.y,f=a.z,a=a.w,h=b.x,j=b.y,i=b.z,b=b.w;c.x=g*b+a*h+e*i-f*j;c.y=e*b+a*j+f*h-g*i;c.z=f*b+a*i+g*j-e*h;c.w=a*b-g*h-e*j-f*i;return c};d.cross=function(a,b,c){"undefined"===typeof c&&(c=null);c||(c=new d);var g=a.x,e=a.y,f=a.z,a=a.w,h=b.x,j=b.y,i=b.z,b=b.w;c.x=a*i+f*b+g*j-e*h;c.y=a*b-g*h-e*j-f*i;c.z=a*h+g*b+e*i-
f*j;c.w=a*j+e*b+f*h-g*i;return c};d.shortMix=function(a,b,c,g){"undefined"===typeof g&&(g=null);g||(g=new d);if(0>=c)return g.xyzw=a.xyzw,g;if(1<=c)return g.xyzw=b.xyzw,g;var e=d.dot(a,b),b=b.copy();0>e&&(b.inverse(),e=-e);if(0.9999<e)e=1-c,c=0+c;else var f=Math.sqrt(1-e*e),h=Math.atan2(f,e),f=1/f,e=Math.sin((1-c)*h)*f,c=Math.sin((0+c)*h)*f;g.x=e*a.x+c*b.x;g.y=e*a.y+c*b.y;g.z=e*a.z+c*b.z;g.w=e*a.w+c*b.w;return g};d.mix=function(a,b,c,g){"undefined"===typeof g&&(g=null);g||(g=new d);var e=a.x*b.x+
a.y*b.y+a.z*b.z+a.w*b.w;if(1<=Math.abs(e))return g.xyzw=a.xyzw,g;var f=Math.acos(e),h=Math.sqrt(1-e*e);if(0.001>Math.abs(h))return g.x=0.5*a.x+0.5*b.x,g.y=0.5*a.y+0.5*b.y,g.z=0.5*a.z+0.5*b.z,g.w=0.5*a.w+0.5*b.w,g;e=Math.sin((1-c)*f)/h;c=Math.sin(c*f)/h;g.x=a.x*e+b.x*c;g.y=a.y*e+b.y*c;g.z=a.z*e+b.z*c;g.w=a.w*e+b.w*c;return g};d.fromAxis=function(a,b,c){"undefined"===typeof c&&(c=null);c||(c=new d);var b=0.5*b,g=Math.sin(b);c.x=a.x*g;c.y=a.y*g;c.z=a.z*g;c.w=Math.cos(b);return c};d.identity=(new d).setIdentity();
l.quat=d})(TSM||(TSM={}));
